...
extern "C" {
#endif
const char *TankLevelControl_linear_model_frame()
{
  return "model linearized_model \"TankLevelControl\"\n"
...
const char *TankLevelControl_linear_model_datarecovery_frame()
{
  return "model linearized_model \"TankLevelControl\"\n"
  "  parameter Integer n = 2 \"number of states\";\n"
  "  parameter Integer m = 0 \"number of inputs\";\n"
